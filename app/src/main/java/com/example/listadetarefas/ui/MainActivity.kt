...
import com.example.listadetarefas.ui.AddTaskActivity.Companion.TASK_ID
...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateList() {
        ...
        binding.includeEmpt.emptyState.visibility = if (list.isEmpty())  View.VISIBLE else  View.GONE
